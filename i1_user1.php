...
<button class="button button5"><a href="<?php echo $_SERVER['PHP_SELF'];?>">HOME</a></button>
...
$result1=mysqli_query($conn,"select * from product_details");
$result=mysqli_query($conn,"select * from product_details LIMIT $page1,5");
...
while($row=mysqli_fetch_array($result))
{
	...
	echo "<img src='$path' name='$nm' alt='Image not available!' style='height:140; width:200;' onclick='abc(this.name)'><br><br><br>"; 
...
$next=$page+1;
if(!($page<=1)){
	echo "<a href='i1_user1.php?page=$prev'>Prev &nbsp;&nbsp;&nbsp;</a>";
}
if($pages>=1){
	for($x=1;$x<=$pages;$x++){
...
if(!($page>=$pages)){
	echo "&nbsp;&nbsp;&nbsp;<a href='i1_user1.php?page=$next'>Next &nbsp;&nbsp;&nbsp;</a >";
}
echo "</div>";
?>
</div>
