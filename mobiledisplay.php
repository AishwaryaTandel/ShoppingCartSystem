...
$result1=mysqli_query($conn,"select * from product_details where Prod_type='MOBILE'");
$result=mysqli_query($conn,"select * from product_details where Prod_type='MOBILE' LIMIT $page1,5");
...
$next=$page+1;
if(!($page<=1)){
	echo "<a href='mobiledisplay.php?page=$prev'>Prev &nbsp;&nbsp;&nbsp;</a>";
}
if($pages>=1){
	for($x=1;$x<=$pages;$x++){
...
if(!($page>=$pages)){
	echo "&nbsp;&nbsp;&nbsp;<a href='mobiledisplay.php?page=$next'>Next &nbsp;&nbsp;&nbsp;</a >";
}
echo "</div>";
?>
</div>
